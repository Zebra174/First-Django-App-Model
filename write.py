...
def write_instructors():
    #Add Instructor 
    #Create User
    user_amr = User(first_name='Amr',last_name='Hossam',dob=date(1962, 7, 16))
    user_amr.save()
    
    instructor_amr = Instructor(full_time=True, total_learners=30050)
    #Update The User refrence of instructor_amr to be user_amr
    instructor_amr.user = user_amr
    instructor_amr.save()
