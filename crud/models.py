...
class User(models.Model):
    first_name = models.CharField(null=False, max_length=30, default='Amr')
    last_name = models.CharField(null=False,max_length=30,default='Hossam')
    dob = models.DateField(null=True)

    #Create toString method for object string representation
    def __str__(self):
